...
// Propmt for generate demo component for UI library

Create a reusable React functional component.
Requirements:
- Import React and necessary hooks (like useState if needed)
- Component should accept props for customization (colors, text, size, etc.)
- Use default values for props
- Use inline styling (no external CSS)
- Keep the component simple and clean
- Add basic interactivity if applicable (hover, toggle, input handling, etc.)
- Use modern React (functional components)
Output:
- Only provide the component code
- No explanation   
enter Component name that you want to generate